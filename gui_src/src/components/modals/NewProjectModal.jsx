        ...
        <form onSubmit={onSubmit} className="flex flex-col overflow-y-auto flex-1" style={{ padding: '0 16px 16px 16px', gap: '12px' }}>
          ...
          {activeTab === 'orquestrador' && (
            <>
              ...
              <details style={{ background: '#252526', padding: '8px', borderRadius: '4px', border: '1px solid #3c3c3c' }}>
                <summary style={{ cursor: 'pointer', fontSize: '12px', color: '#ccc', fontWeight: 'bold' }}>Parâmetros Avançados (Orquestrador)</summary>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '12px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '12px' }}>
                     <div className="flex flex-col flex-1" style={{ gap: '4px' }}>
                        <label style={{ fontSize: '11px', color: '#ccc' }}>Max Heartbeats (MemGPT)</label>
          ...
          {activeTab === 'worker' && (
            <>
              ...
              <details style={{ background: '#252526', padding: '8px', borderRadius: '4px', border: '1px solid #3c3c3c' }}>
                <summary style={{ cursor: 'pointer', fontSize: '12px', color: '#ccc', fontWeight: 'bold' }}>Parâmetros Avançados (Worker)</summary>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '12px' }}>
                  <div style={{ display: 'flex', gap: '12px' }}>
                    <div className="flex flex-col flex-1" style={{ gap: '4px' }}>
                      <label style={{ fontSize: '11px', color: '#ccc' }}>Temperature</label>
