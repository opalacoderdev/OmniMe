...
_STRINGS = {
    "en": {
        ...
        "execution_profile_selected": "Execution Profile Selected",
        ...
        "profile_plan_saved": "Execution profile saved as plan in '{path}'.",
        "profile_edit_prompt": "Edit the file if needed, save, and press Enter to continue (or type /cancel to abort)",
    ...
    "pt": {
        ...
        "execution_profile_selected": "Perfil de Execução Selecionado",
        ...
        "profile_plan_saved": "Perfil de execução salvo como plano em '{path}'.",
        "profile_edit_prompt": "Edite o arquivo se necessário, salve, e pressione Enter para continuar (ou digite /cancel para abortar)",
